// ============================================
// routes/mint.js - 민팅 시 서버 데이터 저장 API
// 담당: 장우혁 (백엔드 데이터 + API)
// ============================================
// POST /mint     → 새 NFT 민팅 데이터 저장
// POST /buy      → NFT 구매 시 소유자 변경
// PATCH /nfts/:tokenId/sale → 판매 상태 변경
// ============================================

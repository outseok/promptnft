...
export function RegisterNFT() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { tokenId } = await onChainMint(signer, tokenURI);
      const finalTokenId = tokenId ?? (await getNextTokenId(provider) - 1);
      ...
      await mintNFT({
        ...
        mint_timing: formData.mintTiming,
      });
      ...
      toast.success('NFT \ub4f1\ub85d \uc644\ub8cc! \uad00\ub9ac\uc790 \uc2b9\uc778\uc744 \uae30\ub2e4\ub824\uc8fc\uc138\uc694.', { duration: 5000 });
      setSubmitted(true);
